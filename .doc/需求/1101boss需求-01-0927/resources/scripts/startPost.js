...
(function() {
    ...
    function generateSitemap() {
        ...
        treeUl += "<a id='highlightInteractiveButton' title='加亮交互元件' class='sitemapToolbarButton'></a>";
        treeUl += "</div>";
        ...
        treeUl += "<div style='margin-bottom:10px;'>生成可分享的 URL</div>";
        treeUl += "<input id='sitemapLinkWithPlayer' type='text' class='sitemapLinkField'/>";
        treeUl += "<div class='sitemapOptionContainer'>";
        treeUl += "<div><label><input type='radio' name='sitemapToggle' value='withoutmap'/>无边栏</label></div>";
        treeUl += "<div style='margin-top:10px;'><label><input type='radio' name='sitemapToggle' value='withmap'/>有边栏</label>";

        treeUl += "<div id='sitemapOptionsDiv'>";
        treeUl += "<div class='sitemapUrlOption'><label><input type='checkbox' id='minimizeBox' />最小化边栏 </label></div>";
        ...
        treeUl += "<div class='sitemapUrlOption'><label><input type='checkbox' id='highlightBox' />加亮交互元件</label></div>";

        if($axure.document.configuration.enabledViewIds.length > 0) {
            treeUl += "<div id='viewSelectDiv' class='sitemapUrlOption'><label>视图: <select id='viewSelect'></select></label></div>";
        }
...
(function () {
    ...
    function generatePageNotes() {
        ...
        pageNotesUi += "<div class='pluginNameHeader'>备注</div>";
        ...
        pageNotesUi += "<div id='pageNotesEmptyState' class='emptyStateContainer'><div class='emptyStateTitle'>此页面没有备注.</div><div class='emptyStateContent'>在 Axure RP 中添加的备注将显示在此处.</div><div class='dottedDivider'></div></div>";
...
(function () {
    ...
    function generateDebug() {
        ...
        pageNotesUi += "<div class='pluginNameHeader'>控制</div>";
        pageNotesUi += "<div class='pageNameHeader'></div>";
        ...
        pageNotesUi += "<div id='traceEmptyState' class='emptyStateContainer'><div class='emptyStateTitle'>跟踪中没有交互.</div><div class='emptyStateContent'>触发的交互会显示在此处.</div><div class='dottedDivider'></div></div>";
